import ChatAssist from "@/app/components/ChatAssist";
import content from "@/content/digesto-ai";

export default function HeroHome() {
  const { hero, chat } = content;
    ...
    <section>
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="py-12 md:py-20">
          ...
          <div id="chat" className="relative" data-aos="fade-up" data-aos-delay={500}>
            <ChatAssist title={chat.title} subtitle={chat.subtitle} />
          </div>
        </div>
      </div>
    </section>
